...
const Hero = ({openModal}) => {
  return (
    <section className="relative h-screen">
      <div
        className="absolute inset-0 bg-cover bg-center bg-red-800/90"
        // style={{
      ...
      <div className="absolute top-[60%] lg:top-[30%] z-20 w-full overflow-hidden">
        <Marquee direction="left" gradient={false} >
		  ...
		  AQVO – SIFAT VA HALOLIKNI O'ZIDA MUJASSAM ETGAN YANGI TAM UYG'UNLIGI.
          </div>
        </Marquee>
      </div>
      <div className="container relative z-10 h-full">
        <div className="flex items-start pt-36 lg:pt-0 lg:items-end h-full pb-14">
          <div className="flex lg:flex-row flex-col gap-6 items-center  justify-between w-full">
            <div className="max-w-[460px] text-center lg:text-left lg:max-w-[237px] text-[#fff]">AQVO – O‘zbekistonda birinchi bo‘lib sifat va halollikni o‘zida mujassam etgan, jizz mahsulotlarini yangicha ta’m va zamonaviy dizaynda taqdim etuvchi yetakchi brend.
            </div>
